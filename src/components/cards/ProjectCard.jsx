    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-[#141515] max-w-2xl w-full rounded-xl p-10 border border-gray-800 relative">
            ...
            {features && (
              <ul className="text-gray-400 text-sm list-disc ml-5 space-y-1 mb-6">
                {features.map((f, i) => (
                  <li key={i}>{f}</li>
                ))}
              </ul>
